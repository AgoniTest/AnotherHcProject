<template>
  <div class="charts-data">
    <el-tabs type="border-card" v-model="tabPosition">
      ...
      <el-tab-pane label="折线堆图" name="manyline">
         <Charts :chartData="chartData" chartType="manyline"></Charts>
      </el-tab-pane>
      <el-tab-pane label="多柱状图" name="manybar">
         <Charts :chartData="chartData" chartType="manybar"></Charts>
      </el-tab-pane>
      <el-tab-pane label="柱折混合" name="barandlinemix">
          <Charts :chartData="chartData" chartType="barandlinemix"></Charts>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
